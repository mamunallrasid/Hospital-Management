              ...
              <div class="card-body">
                <form method="POST" id="categoryRequest">
                  ...
                  <div class="mb-3 d-flex justify-content-center mt-5">
                   <button type="submit" id="submit" onclick="requestSend($('#categoryRequest'),'{{route('admin.category.store')}}')" name="submit" class="btn btn-primary waves-effect waves-light">Submit</button>
                  </div>
                  </div>
                </form>
              </div>
