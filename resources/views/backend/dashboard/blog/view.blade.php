    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <div class="card">
          <div class="card-body">
                  ...
                  <h5 class="mb-3">Display Blog
                      <small class="text-muted float-end">
                          <a href="{{ route('admin.blog.create') }}" class="btn btn-success">Add</a>
                  ...
                  <div class="row">
                      ...
                      <input type="hidden" name="display_url" id="display_url" value="{{ route('admin.blog.display') }}">
                ...
                <table class="table table-bordered text-center table-sm" id="mytable" style="border: 1px solid gray;">
                   <thead>
                      <tr>
                         ...
                         <th class="text-center">ShortDesc</th>
...
@endsection()
@section('script')
<script src="{{url('backend/custom-js/display/blog.js')}}"></script>
<script>
    sidebarSelectMaintain("blog-menu","view-blog");
</script>
@endsection()
