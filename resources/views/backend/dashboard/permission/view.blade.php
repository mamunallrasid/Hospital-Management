    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <div class="card">
          <div class="card-body">
                  ...
                  <h5 class="mb-3">Display Role
                      <small class="text-muted float-end">
                          <a href="{{ route('admin.permission.create') }}" class="btn btn-success">Add</a>
                  ...
                  <div class="row mb-3">
                      ...
                      <input type="hidden" name="display_url" id="display_url" value="{{ route('admin.permission.display') }}">
...
@endsection()
@section('script')
<script src="{{url('backend/custom-js/display/permission.js')}}"></script>


<script>
    sidebarSelectMaintain("permission-menu","view-permission");
</script>
@endsection()
