    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <div class="card">
          <div class="card-body">
                  ...
                  <h5 class="mb-3">Display Sub Category
                      <small class="text-muted float-end">
                          <a href="{{ route('admin.sub-category.create') }}" class="btn btn-success">Add</a>
                  ...
                  <div class="row">
                      ...
                      <input type="hidden" name="display_url" id="display_url" value="{{ route('admin.sub-category.display') }}">
...
@endsection()
@section('script')
<script src="{{url('backend/custom-js/display/sub-category.js')}}"></script>
<script>
    sidebarSelectMaintain("sub-category-menu","view-sub-category");
</script>
@endsection()
