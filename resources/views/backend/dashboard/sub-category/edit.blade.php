              ...
              <div class="card-body">
                <form method="POST" id="subcategoryRequest">
                  ...
                  <div class="mb-3 d-flex justify-content-center mt-5">
                   ...
                   <button type="submit" id="submit" onclick="requestSend($('#subcategoryRequest'),'{{route('admin.sub-category.update')}}')" name="submit" class="btn btn-primary waves-effect waves-light">Submit</button>
                  </div>
                  </div>
                </form>
              </div>
