                ...
                <div class="product-list p-3 mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="{{url('vertical/assets/images/icons/chair.png')}}" alt="" />
                                </div>
                                <div class="ms-2">
                    ...
                    <div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="{{url('vertical/assets/images/icons/user-interface.png')}}" alt="" />
                                </div>
                                <div class="ms-2">
                    ...
                    <div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="{{url('vertical/assets/images/icons/watch.png')}}" alt="" />
                                </div>
                                <div class="ms-2">
                    ...
                    <div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="{{url('vertical/assets/images/icons/idea.png')}}" alt="" />
                                </div>
                                <div class="ms-2">
                    ...
                    <div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="{{url('vertical/assets/images/icons/tshirt.png')}}" alt="" />
                                </div>
                                <div class="ms-2">
                    ...
                    <div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="{{url('vertical/assets/images/icons/headphones.png')}}" alt="" />
                                </div>
                                <div class="ms-2">
                    ...
                    <div class="row border mx-0 py-2 radius-10 cursor-pointer">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="{{url('vertical/assets/images/icons/shoes.png')}}" alt="" />
                                </div>
                                <div class="ms-2">
        ...
        <div class="col-12 col-xl-6 d-flex">
            <div class="card radius-10 w-100">
                ...
                <div class="customers-list p-3 mb-3">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="{{url('vertical/assets/images/avatars/avatar-23.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="{{url('vertical/assets/images/avatars/avatar-20.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="{{url('vertical/assets/images/avatars/avatar-16.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="{{url('vertical/assets/images/avatars/avatar-25.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="{{url('vertical/assets/images/avatars/avatar-17.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                        </div>
                        <div class="ms-2">
