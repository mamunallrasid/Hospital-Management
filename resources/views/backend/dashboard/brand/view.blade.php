    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <div class="card">
          <div class="card-body">
                  ...
                  <h5 class="mb-3">Display Brand
                      <small class="text-muted float-end">
                          <a href="{{ route('admin.brand.create') }}" class="btn btn-success">Add</a>
                  ...
                  <div class="row">
                      ...
                      <input type="hidden" name="display_url" id="display_url" value="{{ route('admin.brand.display') }}">
...
@endsection()
@section('script')
<script src="{{url('backend/custom-js/display/brand.js')}}"></script>
<script>
    sidebarSelectMaintain("brand-menu","view-brand");
</script>
@endsection()
