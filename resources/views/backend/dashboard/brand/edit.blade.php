              ...
              <div class="card-body">
                <form method="POST" id="brandRequest">
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="enter brand type" value="{{ $data->name }}" required>
                  </div>
                  <div class="mb-3 col-md-6">
                  ...
                  <div class="mb-3 d-flex justify-content-center mt-5">
                   ...
                   <button type="submit" id="submit" onclick="requestSend($('#brandRequest'),'{{route('admin.brand.update')}}')" name="submit" class="btn btn-primary waves-effect waves-light">Submit</button>
                  </div>
                  </div>
                </form>
              </div>
