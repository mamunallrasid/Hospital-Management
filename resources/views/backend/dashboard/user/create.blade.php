              ...
              <div class="card-body">
                <form method="POST" id="permissionRequest">
                  ...
                  <div class="mb-3 d-flex justify-content-center mt-5">
                   <button type="submit" id="submit" onclick="requestSend($('#permissionRequest'),'{{route('admin.user.store')}}')" name="submit" class="btn btn-primary waves-effect waves-light">Submit</button>
                  </div>
                  </div>
                </form>
              </div>
