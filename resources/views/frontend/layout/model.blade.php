                ...
                <div class="modal-inner-area sp-area row">
                    ...
                    "asNavFor": ".sp-img_slider-nav"
                                ...
                                <div class="single-slide red">
                                    <img src="{{url('webpage/assets/images/single-product/large-size/1.jpg')}}"
                                        alt="Hiraola's Product Image">
                                </div>
                                <div class="single-slide orange">
                                    <img src="{{url('webpage/assets/images/single-product/large-size/2.jpg')}}"
                                        alt="Hiraola's Product Image">
                                </div>
                                <div class="single-slide brown">
                                    <img src="{{url('webpage/assets/images/single-product/large-size/3.jpg')}}"
                                        alt="Hiraola's Product Image">
                                </div>
                                <div class="single-slide umber">
                                    <img src="{{url('webpage/assets/images/single-product/large-size/4.jpg')}}"
                                        alt="Hiraola's Product Image">
                                </div>
                            </div>
                   ...
                   "focusOnSelect": true
                        ...
                        {"breakpoint":321, "settings": {"slidesToShow": 2}}
                                ...
                                <div class="single-slide red">
                                    <img src="{{url('webpage/assets/images/single-product/small-size/1.jpg')}}"
                                        alt="Hiraola's Product Thumnail">
                                </div>
                                <div class="single-slide orange">
                                    <img src="{{url('webpage/assets/images/single-product/small-size/2.jpg')}}"
                                        alt="Hiraola's Product Thumnail">
                                </div>
                                <div class="single-slide brown">
                                    <img src="{{url('webpage/assets/images/single-product/small-size/3.jpg')}}"
                                        alt="Hiraola's Product Thumnail">
                                </div>
                                <div class="single-slide umber">
                                    <img src="{{url('webpage/assets/images/single-product/small-size/4.jpg')}}"
                                        alt="Hiraola's Product Thumnail">
                                </div>
                            </div>
                        </div>
